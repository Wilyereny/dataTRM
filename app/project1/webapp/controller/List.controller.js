    ...
    return BaseController.extend("project1.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                EXCH_RATE: function(oContext) {
                    var iNumber = oContext.getProperty('EXCH_RATE'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("RATE_TYPE", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("EXCH_RATE", FilterOperator.LE, 100));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("EXCH_RATE", FilterOperator.GT, 100));
                        break;
                    default :
                        break;
                }
